<div class="stack-h stack-h-xs items-center">
	<div class="bg-primary border-primary h-3 w-3 border bg-opacity-75 sm:h-5 sm:w-5" />
	<span class="font-sans-alt text-xs sm:text-sm">Parcel</span>
</div>
<div class="stack-h stack-h-xs items-center">
	<div
		class="bg-secondary border-secondary relative h-3 w-3 border-[3px] bg-opacity-10 sm:h-5 sm:w-5"
	>
		<div
